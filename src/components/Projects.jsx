const Projects = () => {
  const projects = [
    {
      title: "RMK ZapOut – Role-Based Campus Workflow Automation System",
      desc: "A full-stack workflow automation system designed to manage gate pass and on-duty processes with real-time approvals, role-based authorization, and audit tracking.",
      tags: [
        "React",
        "Tailwind CSS",
        "Node.js",
      ...
      demo: null,
      github: "https://github.com/Santhoshv1205/RMK-ZapOut",
    },
    {
      ...
      demo: null,
      github:
        "https://github.com/Santhoshv1205/Human-Tracking-Bot-Using-Sensor-Fusion",
      ...
      <div className="grid md:grid-cols-2 gap-8">
        {projects.map((p, i) => (
          ...
          >
            ...
            {/* Buttons only if at least one exists */}
            {(p.demo || p.github) && (
